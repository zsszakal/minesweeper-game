...
class Cell:
    ...
    def surrounded_cells(self):
        ...
        # Eliminate None values in surrounded_cells
        cells = [cell for cell in cells if cell is not None]
        return cells

    #Count the mines in the surrounded cells when a cell is clicked
    @property
    ...
    def show_mine(self):
        ...
        ctypes.windll.user32.MessageBoxW(0, 'You clicked on a mine O_o', 'Game over', 0)
        sys.exit()
    ...
    def right_click_actions(self, event):
        if not self.is_mine_candidate:
            ...
            self.cell_btn_object.configure(
                bg='SystemButtonFace' # Default grey color of the window to undo mine candidate
            )
            self.is_mine_candidate = False
